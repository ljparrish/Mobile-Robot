...
typedef struct 
{
    int x_position;                 // Integer Position of robot in X measured in mm
    int y_position;                 // Integer Position of robot in Y measured in mm
    int theta;                      // Integer Heading of robot  measured in mRad
...
typedef struct 
{
    int8_t w_right_cmd;           // Right motor commanded angular velocity in pulses per second 
    int8_t w_left_cmd;            // Left motor commanded angular velocity in pulses per second 
